...
import 'CompactReviewDataTable.dart';
import 'customer_rating_review_model.dart';

class CustomerRatingReviewTable extends StatefulWidget {
  const CustomerRatingReviewTable({super.key});

  @override
  State<CustomerRatingReviewTable> createState() => _CustomerRatingReviewTableState();
}

class _CustomerRatingReviewTableState extends State<CustomerRatingReviewTable> {
