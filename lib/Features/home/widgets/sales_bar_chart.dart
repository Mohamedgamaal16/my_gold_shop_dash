  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        // You can define height relative to available constraints or screen size
        double chartHeight;

        if (constraints.maxWidth >= 1000|| constraints.maxHeight >= 600) {
          // Web/Desktop
          chartHeight = 400;
        } else if (constraints.maxWidth >= 600|| constraints.maxHeight >= 400) {
          // Tablet
          chartHeight = 300;
        } else {
          // Mobile
                  ...
                  BarChartData(
                    ...
                    gridData: FlGridData(
                      ...
                      getDrawingHorizontalLine:
                          (value) => FlLine(
                            color: AppColors.greyScaleDarkGrey,
                            strokeWidth: 1,
                          ),
                    ),
